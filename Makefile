...
OPTFLAGS = -O3 -DPRINT_DIST_STATS -DPRINT_EXTRA_NEDGES #-DAGGR_BUFR -DSTM8_ONESIDED -DUSE_EUCLIDEAN_CLASSIFIER #-DUSE_CL_MODEL -DPRINT_GRAPH_EDGES #-DSET_BATCH_SIZE -DUSE_ALLTOALLV  
